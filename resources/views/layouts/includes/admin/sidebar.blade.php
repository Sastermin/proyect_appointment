...
<aside id="logo-sidebar" 
    ...
    -translate-x-full bg-white border-r border-blue-200 sm:translate-x-0 
        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                        <a href="#" class="flex items-center w-full p-2 pl-11 rounded-lg 
                            hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white text-gray-900">
                            Products
                        </a>
                    </li>
                    <li>
